...
public class PatientController : MonoBehaviour
{
    ...
    public void CreatePatientTree()
    {
        ...
        root.Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "LeftKnee" });
        root.Nodes[1].Nodes[0].Nodes[0].Nodes.Add(new TreeNode { Value = "Flexion" });
        root.Nodes[1].Nodes[0].Nodes[0].Nodes.Add(new TreeNode { Value = "Extension" });
        root.Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "RightKnee" });
        root.Nodes[1].Nodes[0].Nodes[1].Nodes.Add(new TreeNode { Value = "Flexion" });
        root.Nodes[1].Nodes[0].Nodes[1].Nodes.Add(new TreeNode { Value = "Extension" });
        root.Nodes[1].Nodes.Add(new TreeNode { Value = "Ankle" });
        root.Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "LeftAnkle" });
        root.Nodes[1].Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "Dorsiflexion" });
        root.Nodes[1].Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "Plantarflexion" });
        root.Nodes[1].Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "Inversion" });
        root.Nodes[1].Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "Eversion" });
        root.Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "RightAnkle" });
        root.Nodes[1].Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "Dorsiflexion" });
        root.Nodes[1].Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "Plantarflexion" });
        root.Nodes[1].Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "Inversion" });
        root.Nodes[1].Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "Eversion" });
