...
public class PatientController : MonoBehaviour
{
    ...
    public void CreatePatientTree()
    {
        ...
        root.Nodes[1].Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "Abduction" });
        root.Nodes[1].Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "Adduction" });
        root.Nodes[1].Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "Internal Rotation" });
        root.Nodes[1].Nodes[1].Nodes[0].Nodes.Add(new TreeNode { Value = "External Rotation" });
        ...
        root.Nodes[1].Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "Abduction" });
        root.Nodes[1].Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "Adduction" });
        root.Nodes[1].Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "Internal Rotation" });
        root.Nodes[1].Nodes[1].Nodes[1].Nodes.Add(new TreeNode { Value = "External Rotation" });
        root.Nodes[1].Nodes.Add(new TreeNode { Value = "Ankle" });
        root.Nodes[1].Nodes[2].Nodes.Add(new TreeNode { Value = "LeftAnkle" });
        root.Nodes[1].Nodes[2].Nodes[0].Nodes.Add(new TreeNode { Value = "Flexion" });
        root.Nodes[1].Nodes[2].Nodes[0].Nodes.Add(new TreeNode { Value = "Extension" });
        root.Nodes[1].Nodes[2].Nodes[0].Nodes.Add(new TreeNode { Value = "Abduction" });
        root.Nodes[1].Nodes[2].Nodes[0].Nodes.Add(new TreeNode { Value = "Adduction" });
        root.Nodes[1].Nodes[2].Nodes[0].Nodes.Add(new TreeNode { Value = "Internal Rotation" });
        root.Nodes[1].Nodes[2].Nodes[0].Nodes.Add(new TreeNode { Value = "External Rotation" });
        root.Nodes[1].Nodes[2].Nodes.Add(new TreeNode { Value = "RightAnkle" });
        root.Nodes[1].Nodes[2].Nodes[1].Nodes.Add(new TreeNode { Value = "Flexion" });
        root.Nodes[1].Nodes[2].Nodes[1].Nodes.Add(new TreeNode { Value = "Extension" });
        root.Nodes[1].Nodes[2].Nodes[1].Nodes.Add(new TreeNode { Value = "Abduction" });
        root.Nodes[1].Nodes[2].Nodes[1].Nodes.Add(new TreeNode { Value = "Adduction" });
        root.Nodes[1].Nodes[2].Nodes[1].Nodes.Add(new TreeNode { Value = "Internal Rotation" });
        root.Nodes[1].Nodes[2].Nodes[1].Nodes.Add(new TreeNode { Value = "External Rotation" });
